$(document).ready(function(){function k(){e.clearScreen();e.drawShape(a.shape)}function g(){for(var a=b.getPosition(),d=0;d<b.world.bodies.length;d++){var e=b.world.bodies[d],h=e.getVerticesInWorldCoords(),g=MV.min(h,0),k=MV.min(h,1),l=MV.max(h,0),h=MV.max(h,1);if(a[0]>=g&&a[1]>=k&&a[0]<=l&&a[1]<=h)return e}return null}$("body").on("contextmenu","#game",function(a){return!1});var b=new Game,e=new Canvas("drawing");b.start();var l=[0,0];KeyReader.onkeydown(KeyReader.KEY_ENTER,function(){if("convex"==
    ...
    new Color(c):null!=a.selectedBody&&(a.selectedBody.shape.color=new Color(c),b.running||b.canvas.drawWorld(b.world))});$("#tipo").change(function(){var b="true"==document.getElementById("tipo").value;null!=a.selectedBody&&a.selectedBody.setDinamic(b)});$("#game").click(function(){if(a.drawing)switch(a.selected){case "quadrado":a.drawing=!1;e.clearScreen();d=new Body(a.shape,Material.Iron,"true"==$("#tipo").val());b.world.add(d);a.drawPoint=null;b.running||b.canvas.drawWorld(b.world);break;case "convex":c=
    b.getPosition();a.shape.vertices.splice(a.shape.vertices.length-1,1);null!=a.auxpoint?(a.shape.vertices[a.shape.vertices.length]=a.auxpoint,a.auxpoint=null):a.shape.vertices[a.shape.vertices.length]=c;a.shape.vertices[a.shape.vertices.length]=a.drawPoint;break;case "regular":a.drawing=!1;e.clearScreen();d=new Body(a.shape,Material.Iron,"true"==$("#tipo").val());b.world.add(d);a.shape=null;a.drawPoint=null;b.running||b.canvas.drawWorld(b.world);break;case "chain":a.drawing=!1,d=g(),null!=d&&a.joint.bodyA!=
    d&&(c=b.getPosition(),a.joint.vertexB=[d.center[0]-c[0],d.center[1]-c[1]],a.joint.bodyB=d,b.world.addJoint(a.joint),a.joint=null,a.drawing=!0)}else{var c=b.getPosition();a.drawPoint=c;if("quadrado"==a.selected)a.shape=new Rect([0,0],10,10),a.shape.color=new Color(document.getElementById("preenchimento").value),a.drawing=!0;else if("convex"==a.selected)a.shape=new Polygon([0,0],0),a.shape.vertices[a.shape.vertices.length]=[c[0],c[1]],a.shape.vertices[a.shape.vertices.length]=a.drawPoint,a.shape.color=new Color(document.getElementById("preenchimento").value),
    a.drawing=!0;else if("regular"==a.selected)null==a.shape&&(a.shape=new Regular([c[0],c[1]],10),a.shape.color=new Color(document.getElementById("preenchimento").value)),a.drawing=!0;else if("eraser"==a.selected){var d=g();null!=d&&b.world.remove(d);b.running||b.canvas.drawWorld(b.world)}else if("cursor"==a.selected)d=g(),null!=d&&(null!=a.selectedBody&&(a.selectedBody.shape.border.lineDash=[]),d.shape.border.lineDash=[5,5],document.getElementById("preenchimento").value=d.shape.color.toHEX(),document.getElementById("tipo").value=
    d.dinamic,a.selectedBody=d,b.running||b.canvas.drawWorld(b.world));else if("move"==a.selected){if(d=g(),null!=d&&d.dinamic){c=new Shape(a.drawPoint);c.vertices[0]=[0,0];c.center=a.drawPoint;var f=new MouseBody(c);f.center=a.drawPoint;a.mousejoint=new Joint(f,0,d,0);b.world.addJoint(a.mousejoint)}}else"chain"==a.selected&&(f=g(),null!=f&&(c=b.getPosition(),a.joint=new Joint,a.joint.type="surface",a.joint.vertexA=[f.center[0]-c[0],f.center[1]-c[1]],a.joint.bodyA=f,a.drawing=!0))}});$("#game").mousemove(function(){var c=
    b.getPosition();if(a.drawing&&null!=a.shape)switch(e.clearScreen(),a.selected){case "quadrado":c=MV.VmV(c,a.drawPoint);a.shape.updateDimen(Math.abs(c[0]),Math.abs(c[1]));a.shape.center=[a.drawPoint[0]+c[0]/2,a.drawPoint[1]+c[1]/2];e.drawShape(a.shape);break;case "convex":var d=a.drawPoint[0],f=a.drawPoint[1];a.drawPoint[0]=c[0];a.drawPoint[1]=c[1];a.shape.isConvex()&&(a.drawPoint[0]=d,a.drawPoint[1]=f,a.auxpoint=[d,f]);e.drawShape(a.shape);break;case "regular":c=Math.abs(MV.distance(c,a.drawPoint));
