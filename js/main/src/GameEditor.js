    ...
    var GameEditor = {
        ...
        initializeTools:function(){
            ...
            setInterval(function(){
                if(!self.drawing && world.bodies.length < Global.maxBodies){
                    var body = new Body(new Regular({
                        radius:5,
                        sides:10,
                        center:[300,200],
                        color:Color.random()
                    }),Material.Iron,true,[0,0],0);
                    world.add(body);
                }
            },100);
            ...
            krd.onSequence([KeyReader.Keys.KEY_ENTER],function(){
                ...
                if(self.selectedTool == 'convex' && self.drawing){
                    ...
                    if(shape.vertices.length >= 3 && !shape.isConvex()){
                        ...
                        var body = new Body(shape,Material.Iron,self.dinamic,[0,0],0);
        ...
        executeRectTool:function(point){
            ...
            if(!self.drawing){
                ...
                self.drawing = false;
                var body = new Body(self.shape,Material.Iron,self.dinamic,[0,0],0);
